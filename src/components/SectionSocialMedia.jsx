      ...
      <div className="w-full max-w-[650px] mx-auto px-6 3sm:px-10 border-deco-gray">
        <div className="flex flex-col text-center gap-4 4sm:flex-row">
          <Title
            ref={titleRef}
            classes={clsx(
              "4sm:text-start 4sm:w-78 transition duration-1000 ease-out",
              {
          ...
          <div className="grid grid-cols-6 gap-4 md:flex md:flex-col">
            <div
              ref={instagramRef}
              className={clsx("transition duration-1000 ease-out col-span-3", {
            ...
            >
              <LinkButton
                ...
                target="_blank"
                classes="outline outline-deco-gray text-deco-gray hover:outline-0 hover:bg-[url(/bg-instagram.jpg)] hover:bg-cover hover:bg-center hover:text-[#FFFFFF] flex items-center justify-center "
              >
            ...
            >
              <LinkButton
                ...
                target="_blank"
                classes="outline outline-deco-gray text-deco-gray hover:outline-0 hover:bg-[#1877F2] hover:text-[#FFFFFF] flex items-center justify-center  transition ease-out"
              >
            ...
            >
              <LinkButton
                ...
                target="_blank"
                classes="border border-deco-gray text-deco-gray hover:border-black hover:bg-black hover:text-[#FFFFFF] flex items-center justify-center  transition ease-out"
              >
            ...
            >
              <LinkButton
                ...
                target="_blank"
                classes="border border-deco-gray text-deco-gray hover:border-[#C4302B] hover:bg-[#B33636] hover:text-[#FFFFFF] flex items-center justify-center  transition ease-out"
              >
