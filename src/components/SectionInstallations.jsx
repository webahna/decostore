    ...
    <section id="installations" className={`w-full  px-4 ${classes}`}>
      <div className="md:max-w-[990px] md:mx-auto text-center py-20 md:py-[120px]">
        <p
          ref={ourServicesRef}
          className={clsx(
            "text-deco-green font-semibold transition-all duration-500 ease-out",
            {
        ...
        <p
          ref={subTitleRef}
          className={clsx(
            "text-base md:text-xl transition-all duration-500 ease-out text-deco-gray",
            {
        ...
        <div className="grid grid-cols-6 md:grid-cols-3 mt-4 md:mt-16 gap-y-8 gap-x-6 md:gap-x-0 max-w-[650px] mx-auto">
          ...
          <div
            ref={cespedResidRef}
            className={clsx(
              "flex flex-col items-center col-span-2 col-start-2 md:col-auto transition-all duration-500 ease-out",
              {
          ...
          >
            ...
            <a
              ...
              className="pt-5 pb-1 text-sm font-bold text-deco-green-title border-b"
            >
              Ver más
              <FontAwesomeIcon
          ...
          <div
            ref={cespedDepoRef}
            className={clsx(
              "flex flex-col items-center col-span-2 col-start-4 md:col-auto transition-all duration-500 ease-out",
              {
          ...
          <div
            ref={lambrinRef}
            className={clsx(
              "flex flex-col items-center col-span-2 col-end-4 md:col-auto transition-all duration-500 ease-out",
              {
          ...
          <div
            ref={persianasRef}
            className={clsx(
              "flex flex-col items-center col-span-2 col-end-6 md:col-auto transition-all duration-500 ease-out",
              {
